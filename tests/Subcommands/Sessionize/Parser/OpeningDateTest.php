...
#[CoversClass(OpeningDate::class)]
class OpeningDateTest extends TestCase
{
    ...
    public function testThatUriIsReturnedCorrectly($file, $result)
    {
        ...
        $parser = new OpeningDate($timezone);
    ...
    public static function uriIsReturnedCorrectlyProvider() : array
    {
        return [[
            ...
            new DateTimeImmutable('2019-01-20T00:00:00.000000', new DateTimeZone('Europe/Amsterdam')),
        ], [
            __DIR__ . '/../__assets/React Week Medellín 2019: Call for Speakers @ Sessionize.com.html',
            new DateTimeImmutable('2019-01-21T00:00:00.000000', new DateTimeZone('Europe/Amsterdam')),
        ],];
    }
}
